...
exports.login = login;
},{"./alert":"alert.js"}],"user.js":[function(require,module,exports) {
"use strict";
...
var signUp = function signUp(firstname, lastname, username, phone, email, address, password, repassword) {
  var res;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 7:
          _context.prev = 7;
          _context.t0 = _context["catch"](0);
          (0, _alert.showAlert)('danger', 'Sign up fail!');
...
var logOut = function logOut() {
  try {
    ...
    (0, _alert.showAlert)('danger', 'Logged out fail!');
  }
};

exports.logOut = logOut;
},{"./alert":"alert.js"}],"../../node_modules/process/browser.js":[function(require,module,exports) {
...
},{"process":"../../node_modules/process/browser.js"}],"product.js":[function(require,module,exports) {
"use strict";
...
var addProduct = function addProduct(name, price, description, imagesCover, images, categories, amount, sales, optionName, optionVals) {
  var res;
...
},{"q":"../../node_modules/q/q.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
if (signUpForm) {
  signUpForm.addEventListener('submit', function (e) {
    ...
    (0, _user.signUp)(firstname, lastname, username, phone, email, address, password, repassword);
  });
}

var logOutBtn = document.querySelector('.nav_logout');
